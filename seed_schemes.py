...
SCHEMES = [
    {
        ...
        "documents_required": ["Aadhaar card", "Land records (Khasra / Khatauni)", "Bank account passbook"],
    ...
    },
    {
        ...
        "documents_required": ["Job card", "Aadhaar card", "Bank account passbook"],
    ...
    },
    {
        ...
        "documents_required": ["Aadhaar card", "Ration / BPL card", "Bank account passbook"],
    ...
    },
    {
        ...
        "documents_required": ["Birth certificate", "Aadhaar card", "Domicile / Residence certificate"],
    ...
    },
    {
        ...
        "documents_required": ["Aadhaar card", "Land records (Khasra / Khatauni)", "Sowing certificate", "Bank account passbook"],
    ...
    },
    {
        ...
        "documents_required": ["Aadhaar card", "Age proof", "Ration / BPL card", "Bank account passbook"],
    ...
    },
    {
        ...
        "documents_required": ["Caste certificate", "Income certificate", "Mark sheets", "Bank account passbook"],
    ...
    },
    {
        ...
        "documents_required": ["Aadhaar card", "Bank account passbook", "Aadhaar-linked mobile number"],
